#ifndef _2D_HELIX_IR2_POTENTIAL_HPP
#define _2D_HELIX_IR2_POTENTIAL_HPP
...
namespace {
    ...
    void output_potential_param() {
        ioer::info("# 2D Helix potential [with phi = W * r**2] parameters: ", 
                    " A = ", param_A,
                    " B = ", param_B,
                    " C = ", param_C,
                    " D = ", param_D,
    ...
    vector<double> cal_der_phi(const vector<double>& r) {
        ...
        der_phi[0] = 2.0 * param_W * x;
        der_phi[1] = 2.0 * param_W * y;
        return der_phi;
    }
