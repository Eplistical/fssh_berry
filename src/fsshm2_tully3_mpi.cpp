...
#include "2d_tully3_potential.hpp"
...
double sigma_py = 1.0; 
double init_s = 0.0;
double xwall_left = -15.0;
double xwall_right = 15.0;
int Nstep = 1000000;
double dt = 0.1;
int output_step = 100;
int Ntraj = 5000;
...
void fssh() {
    ...
    if (MPIer::master) {
        ...
        ioer::info("# fsshm2 para: ", " Ntraj = ", Ntraj, " Nstep = ", Nstep, " dt = ", dt, " output_step = ", output_step,
                " mass = ", mass, 
