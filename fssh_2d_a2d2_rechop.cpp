...
void fssh() {
    ...
    double n0trans_diab_1 = 0.0, n0refl_diab_1 = 0.0, n1trans_diab_1 = 0.0, n1refl_diab_1 = 0.0;
    double px0trans_diab_1 = 0.0, px0refl_diab_1 = 0.0, px1trans_diab_1 = 0.0, px1refl_diab_1 = 0.0;
    double py0trans_diab_1 = 0.0, py0refl_diab_1 = 0.0, py1trans_diab_1 = 0.0, py1refl_diab_1 = 0.0;
    double Ntraj_1 = 0.0;
    ...
    for (int istep(0); istep < Nstep; ++istep) {
        ...
        if (istep % output_step == 0) {
            ...
            n0trans_diab_1 = n0refl_diab_1 = n1trans_diab_1 = n1refl_diab_1 = 0.0;
            px0trans_diab_1 = px0refl_diab_1 = px1trans_diab_1 = px1refl_diab_1 = 0.0;
            py0trans_diab_1 = py0refl_diab_1 = py1trans_diab_1 = py1refl_diab_1 = 0.0;
            Ntraj_1 = 0.0;
            ...
            for (int itraj = 0; itraj < Ntraj; ++itraj) {
                ...
                */
                ...
                if (vx >= 0.0) {
                    ...
                    if (hop_count[itraj] <= 1.0) {
                        n0trans_diab_1 += n0d;
                        n1trans_diab_1 += n1d;
                        px0trans_diab_1 += mass * vx * n0d;
                        px1trans_diab_1 += mass * vx * n1d;
                        py0trans_diab_1 += mass * vy * n0d;
                        py1trans_diab_1 += mass * vy * n1d;
                        Ntraj_1 += 1.0;
                    }
                }
                else {
                    ...
                    if (hop_count[itraj] <= 1.0) {
                        n0refl_diab_1 += n0d;
                        n1refl_diab_1 += n1d;
                        px0refl_diab_1 += mass * vx * n0d;
                        px1refl_diab_1 += mass * vx * n1d;
                        py0refl_diab_1 += mass * vy * n0d;
                        py1refl_diab_1 += mass * vy * n1d;
                        Ntraj_1 += 1.0;
                    }
                }
            }
            ...
            if (istep == 0) {
                ...
                ioer::tabout('#', "t", "n0trans", "n0refl", "n1trans", "n1refl", "px0trans", "py0trans", "px0refl", "py0refl", "px1trans", "py1trans", "px1refl", "py1refl", "Etot", 
                                  "Ntraj_1", "n0trans_1", "n0refl_1", "n1trans_1", "n1refl_1", "px0trans_1", "py0trans_1", "px0refl_1", "py0refl_1", "px1trans_1", "py1trans_1", "px1refl_1", "py1refl_1");
            }
            ...
            if (n0trans_diab_1 != 0.0) { px0trans_diab_1 /= n0trans_diab_1; py0trans_diab_1 /= n0trans_diab_1; }
            if (n0refl_diab_1 != 0.0) { px0refl_diab_1 /= n0refl_diab_1; py0refl_diab_1 /= n0refl_diab_1; }
            if (n1trans_diab_1 != 0.0) { px1trans_diab_1 /= n1trans_diab_1; py1trans_diab_1 /= n1trans_diab_1; }
            if (n1refl_diab_1 != 0.0) { px1refl_diab_1 /= n1refl_diab_1; py1refl_diab_1 /= n1refl_diab_1; }
            n0trans_diab_1 /= Ntraj_1;
            n0refl_diab_1 /= Ntraj_1;
            n1trans_diab_1 /= Ntraj_1;
            n1refl_diab_1 /= Ntraj_1;
            ...
            ioer::tabout('#', istep * dt, n0trans_diab, n0refl_diab, n1trans_diab, n1refl_diab, px0trans_diab, py0trans_diab, px0refl_diab, py0refl_diab, px1trans_diab, py1trans_diab, px1refl_diab, py1refl_diab, (KE + PE) / Ntraj,
                              Ntraj_1, n0trans_diab_1, n0refl_diab_1, n1trans_diab_1, n1refl_diab_1, px0trans_diab_1, py0trans_diab_1, px0refl_diab_1, py0refl_diab_1, px1trans_diab_1, py1trans_diab_1, px1refl_diab_1, py1refl_diab_1);
